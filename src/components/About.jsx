...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-transparent">
      ...
      <div className="absolute bottom-1/3 right-10 w-96 h-96 rounded-full bg-purple-500/5 blur-3xl -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="space-y-6 max-w-3xl mx-auto flex flex-col items-center">
          <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
            About <span className="text-indigo-400 font-black">Nextshop</span>
          </h2>
          <p className="text-zinc-400 font-light text-base md:text-lg leading-relaxed max-w-2xl">
        ...
        <div className="max-w-4xl mx-auto mt-16 bg-[#121214]/55 backdrop-blur-md border border-zinc-800/80 rounded-[32px] p-6 md:p-8 shadow-sm text-center">
          <h3 className="text-lg font-extrabold text-white tracking-tight mb-8">
            How We're Different
          </h3>
          ...
          <div className="space-y-8 max-w-2xl mx-auto text-left">
            ...
            <div className="flex gap-4.5 items-start">
              <div className="w-9 h-9 rounded-full bg-indigo-950/40 border border-indigo-900/60 flex items-center justify-center text-indigo-400 font-bold flex-shrink-0 text-xs shadow-sm">
                1
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto items-stretch">
            {values.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#121214]/55 backdrop-blur-md border border-zinc-800/80 rounded-[32px] p-6 shadow-sm hover:shadow-md transition-all flex flex-col gap-4.5 text-left"
                >
                  <div className="w-10 h-10 rounded-full bg-indigo-950/40 border border-indigo-900/60 flex items-center justify-center text-indigo-400 flex-shrink-0 shadow-sm">

...
export default function TermsPage() {
  return (
    <div className="pt-32 pb-24 relative overflow-hidden bg-grid-pattern">
      {/* Background accents */}
      <div className="absolute top-1/4 left-10 w-72 h-72 rounded-full bg-indigo-500/5 blur-3xl -z-10"></div>
      <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-purple-500/5 blur-3xl -z-10"></div>

      <div className="max-w-4xl mx-auto px-6 text-left">
        
        {/* Page Header */}
        <div className="space-y-4 mb-12">
          <span className="text-xs font-black text-indigo-400 uppercase tracking-widest block">LEGAL POLICY</span>
        ...
        {/* Content Box */}
        <div className="bg-[#121214]/55 backdrop-blur-md border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-xl space-y-10">
          ...
          <div className="space-y-4">
            ...
            <div className="text-zinc-400 font-light text-xs md:text-sm leading-relaxed space-y-3">
              <p>
